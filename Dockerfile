FROM docker.io/amd64/debian:13-slim@sha256:2db8bbec5bb0cde09e06b4f0bc366539e3758fdb11bd1c399445c97c8f4168ae
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-25.04.10.3.1}"
