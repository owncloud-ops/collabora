FROM docker.io/amd64/debian:12-slim@sha256:ea5ad531efe1ac11ff69395d032909baf423b8b88e9aade07e11b40b2e5a1338
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-23.05.5.3.1}"
