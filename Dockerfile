FROM docker.io/amd64/debian:12-slim@sha256:6bdbd579ba71f6855deecf57e64524921aed6b97ff1e5195436f244d2cb42b12
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-23.05.9.3.1}"
