FROM docker.io/amd64/debian:12-slim@sha256:911821c26cc366231183098f489068afff2d55cf56911cb5b7bd32796538dfe1
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-23.05.10.1.1}"
