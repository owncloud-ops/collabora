FROM docker.io/amd64/debian:12-slim@sha256:903d3225acecaa272bbdd7273c6c312c2af8b73644058838d23a8c9e6e5c82cf
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-24.04.7.2.1}"
