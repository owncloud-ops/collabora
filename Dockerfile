FROM docker.io/amd64/debian:12-slim@sha256:36a9d3bcaaec706e27b973bb303018002633fd3be7c2ac367d174bafce52e84e
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-23.05.8.2.1}"
