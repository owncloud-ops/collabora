FROM docker.io/amd64/debian:12-slim@sha256:ceffa8e71bafc0190f915774b9696a0b6cb6262d1df5f64028b570ca4055ba83
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-23.05.4.2.1}"
