FROM docker.io/amd64/debian:13-slim@sha256:ca48952bbe365a50f43bf742e43ba363a75fdc66ac9a25af60bf4bcfd27d0a56
...
ENV COLLABORA_RAW_VERSION="${BUILD_VERSION:-24.04.13.3.1}"
